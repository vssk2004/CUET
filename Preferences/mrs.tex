...
\slide{Marginal Rate of Substitution (MRS)}{
    \dfn{The slope of an indiﬀerence curve is known as the marginal rate of substitution
    (MRS).}
    ...
    \(\Delta x_2\), an amount that is just suﬃcient to put him back on his indiﬀerence curve.
...
\slide{Diminishing MRS}{
    ...
    the consumer to give We can think about this intuitively:
    \begin{itemize}
